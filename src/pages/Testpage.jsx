        ...
        <div className="test-content">
          ...
          <div className="options">
            <div className="option flex flex-col">
              <p className="options-div text-[20px] font-bold text-white">
                Option-one
              </p>
              <p className="options-div text-[20px] font-bold text-white">
                Option-two
          ...
          <div className="buttons flex justify-between">
            <div className="prev-btn cursor-pointer font-bold text-white ">
              ◀ Previous
            </div>
            <button className="sub-btn font-bold ">Submit</button>
            <div className="next-btn cursor-pointer font-bold text-white ">
              Next ▶
            </div>
          </div>
        </div>
