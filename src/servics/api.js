...
export const handleAddQuestion = (obj) => {
    ...
    const QUE_OBJ = {
        ...
        Answers: [{ Answer: obj.options[0] }, { Answer: obj.options[1] }, { Answer: obj.options[2] }, { Answer: obj.options[3] }],
        CorrectAnswerID: obj.correctOption - 1
    }
    const res = axios.post("http://localhost:3000/question/post/new-question", QUE_OBJ);
    console.log(res);
...
export const deleteQuestionById = async(QuestionID) => {
    try {
        const res = await axios.post(
            "http://localhost:3000/question/delete-question", { QuestionID }, // request body
            {
                headers: {
