...
function TournamentPageCard({ title, type, date, time }) {
  return (
    <div>
      <div className="weekly-tournaments-page-card bg-blue-500 w-fit p-5 rounded-2xl relative shadow-[#0007] shadow-2xl border-2 border-purple-600">
        ...
        <div className="weekly-tournaments-page-card-title  w-[100%] p-3 absolute left-0 bottom-0 rounded-b-xl text-center z-10 bg-purple-900">
