      ...
      >
        ...
        <div className="flex  gap-1 flex-col">
          ...
          <input
            ...
            className="border-b text-lg outline-none "
          />
        </div>
        <div className="flex  gap-1 flex-col">
        ...
        <div className="flex  gap-1 flex-col w-50 ">
          ...
          <select
            ...
            id="userClass"
            required
            className="border-b text-lg outline-none w-full "
            onClick={handleClass}
          >
        ...
        <button
          className={`px-7 text-black font-black py-3 rounded-tl-full rounded-br-full bg-green-500 border submit${
            choosenClass == "class" ? "disabled" : "abled"
          }`}
        >
          Sign Up
        </button>
